...
if darth_maul == True:
    ...
    if politic_action <= 10:
        ...
        if darth_maul_rage >= 9:
            ...
            council_alt_ending = random.randrange(1, 10000)
            if council_alt_ending == 5389:
                print("You and Darth Maul team up killing the entire Jedi order and rule the galaxy side by side.")
            else:
                council_determ = input("Do you have the determination to take down the order? (Y/N): ")
                if council_determ.upper() == "N":
            ...
            while darth_maul:
                ...
                if screwed == 5:
                    ...
                    player_health -= 10
                if screwed == 10:
                    print("Darth Maul mauls you before you have time to think.")
                    player_health -= 25
                    #Jarman added the mauling
                time.sleep(.25)
                print("A. Attack")
                time.sleep(.25)
                print("B. Defend")
...
if order_66 == False:
    ...
    print("You and Darth Maul take the ship and head to Coruscant.")
    time.sleep(.25)
    print("You two have a very uneasy alliance.")
    time.sleep(.25)
    print("You feel you are just one wrong word away from getting a lightsaber in your back.")
    time.sleep(.25)
    print("But you are also very hateful toward the order.")
    time.sleep(.25)
    print("You need to form a stategy.")
    time.sleep(.25)
    print()
    time.sleep(.25)
    print("A. Charge in lightsabers ablazed.")
    time.sleep(.25)
    print("B. Blend in with the citzens of Coruscant and scout out for information.")
    time.sleep(.25)
    print("C. Go to the Jedi order by yourself and become a hidden spy.")
    time.sleep(.25)
    print("D. Try to make conversation with Darth Maul.")
    user_choice4 = input("Choose your action: ")
    if user_choice4.upper() == "A":
        pass
    elif user_choice4.upper() == "B":
        time.sleep(.25)
        print("You leave Darth Maul in the ship and go to the order.")
        time.sleep(.25)
        print("You enter the Jedi Temple and see three jedi awaiting your presence.")
        time.sleep(.25)
        print("Mace Windu, Kit Fisto, and Plo Koon.")
        time.sleep(.25)
        print("Mace Windu approaches you,")
        time.sleep(.25)
        print("Mace Windu: 'We have been watching your progress. Very closely.'")
        time.sleep(.25)
        print("A. Then you see I have suceeded and deserve the rank of Jedi.")
        print("B. Then you know who is in my ship. I knew I couldn't fight him, so take him down with me.")
        print("C. What are you trying to say?")
        print("D. Then you know what is coming!")
        user_choice4 = input("Choose your action: ")
        if user_choice4.upper() == "A":
            print("You: 'Then you see I have suceeded and deserve the rank of Jedi.'")
            print("Mace Windu looks at you suspicously.")
            print("Mace Windu: 'We had some different ideas in mind.'")
            print("Mace Windu: 'On behalf on the Jedi Council, for treason aganist the Jedi Order, you have are hereby under arrest.")
            print()
